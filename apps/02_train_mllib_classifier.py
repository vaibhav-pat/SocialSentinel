...
spark = SparkSession.builder.appName("Train_MLlib_on_Embeddings").getOrCreate()
...
label_indexer = StringIndexer(
    inputCol="label", outputCol="indexedLabel", handleInvalid="keep"
)
...
e1 = MulticlassClassificationEvaluator(
    labelCol="indexedLabel", predictionCol="prediction", metricName="f1"
).evaluate(pred)
e2 = MulticlassClassificationEvaluator(
